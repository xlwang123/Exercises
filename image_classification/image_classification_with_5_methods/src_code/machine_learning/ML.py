# python ML.py --dataset "set_name" --neighbors "# of neighbors"
...
def extract_color_histogram(image,bins=(32,32,32)):
    ...
    # return the flatten histogram as the feature vector
    return hist.flatten()
...
# initialize the raw pixel intensities matrix, the featurew matrix, and label list
rawImages = []
features = []
labels = []
...
for (i,imagePath) in enumerate(imagePaths):
    ...
    # add the message we got to the raw images, features, and labels matricies
...
# show some information on the memory consumed by raw images, matrix and features matrix
...
# partition the data into training and testing splits, using 85% of the data for training and remaining 15% for testing
